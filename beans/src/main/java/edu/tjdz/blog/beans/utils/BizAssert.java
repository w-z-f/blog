package edu.tjdz.blog.beans.utils;

import cn.hutool.core.util.ArrayUtil;
import edu.tjdz.blog.beans.exception.BizException;
import edu.tjdz.blog.beans.exception.code.BaseExceptionCode;


import java.time.LocalDateTime;
import java.util.Collection;

import static edu.tjdz.blog.beans.exception.BaseException.BASE_VALID_PARAM;


/**
 * 断言 包含：fail isTrue(不满足条件则抛出异常)  notNull  notEmpty
 *
 */
